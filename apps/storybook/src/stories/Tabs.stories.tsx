    ...
    <Tabs defaultValue="overview" className="w-full max-w-4xl">
      ...
      <TabsContent value="overview">
        <div className="rounded-lg border p-6">
          ...
          <p className="text-muted-foreground">전체 시스템의 주요 지표를 확인하세요.</p>
        </div>
      </TabsContent>
      <TabsContent value="analytics">
        <div className="rounded-lg border p-6">
          <h3 className="mb-2 text-lg font-semibold">데이터 분석</h3>
          <p className="text-muted-foreground">상세한 데이터 분석 결과를 확인하세요.</p>
        </div>
      </TabsContent>
      <TabsContent value="reports">
        <div className="rounded-lg border p-6">
          <h3 className="mb-2 text-lg font-semibold">보고서</h3>
          <p className="text-muted-foreground">생성된 보고서를 확인하고 다운로드하세요.</p>
        </div>
      </TabsContent>
      <TabsContent value="settings">
        <div className="rounded-lg border p-6">
          <h3 className="mb-2 text-lg font-semibold">설정</h3>
          <p className="text-muted-foreground">시스템 설정을 변경하세요.</p>
        </div>
      </TabsContent>
    </Tabs>
  ),
    ...
    <Tabs defaultValue="profile" className="w-full max-w-2xl">
        ...
        <div className="rounded-lg border bg-card p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" className="w-full rounded-md border px-3 py-2" defaultValue="홍길동" />
            </div>
            <div>
              <label className="mb-2 block text-sm font-medium">이메일</label>
              <input type="email" className="w-full rounded-md border px-3 py-2" defaultValue="hong@example.com" />
            </div>
            <div>
              <label className="mb-2 block text-sm font-medium">소개</label>
              <textarea className="w-full rounded-md border px-3 py-2" rows={3} defaultValue="안녕하세요, 홍길동입니다." />
            </div>
      ...
      <TabsContent value="account" className="space-y-4">
        <div className="rounded-lg border bg-card p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="mb-2 block text-sm font-medium">사용자 이름</label>
              <input type="text" className="w-full rounded-md border px-3 py-2" defaultValue="hong123" />
            </div>
            <div>
            ...
            <div>
              <label className="mb-2 block text-sm font-medium">시간대</label>
              <select className="w-full rounded-md border px-3 py-2">
