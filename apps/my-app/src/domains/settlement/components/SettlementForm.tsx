...
import { type SettlementFormSchema, settlementFormSchema } from '../schemas';
import type { SettlementFormProps } from '../types';
...
export function SettlementForm({ onSubmit, defaultValues }: SettlementFormProps) {
  const { control, handleSubmit, reset } = useForm<SettlementFormSchema>({
  ...
  const handleFormSubmit = (data: SettlementFormSchema) => {
    console.log('✅ Form submitted:', data);
    onSubmit(data);
  };

  const handleFormError = (errors: FieldErrors<SettlementFormSchema>) => {
